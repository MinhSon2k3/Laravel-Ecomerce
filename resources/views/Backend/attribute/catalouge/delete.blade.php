...
@endif
<form action="{{ route('attribute.catalouge.destroy', ['id' => $attributeCatalouge->id]) }}" method="post" class="box">
    @csrf
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <p> <strong>{{__('messages.deletenoitice')}}</strong> {{$attributeCatalouge->name}}</p>
