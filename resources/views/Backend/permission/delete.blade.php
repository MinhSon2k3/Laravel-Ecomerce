...
<form action="{{ route('permission.destroy', ['id' => $permission->id]) }}" method="post" class="box">
    @csrf
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    <div class="panel-title">
                        <p> <strong>Bạn có chắc muốn xóa ngôn ngữ :</strong> {{$permission->name}}</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="name" value="{{old('email',($permission->name) ?? '')}}" class="form-control" placeholder="" autocomplete="off" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="name" value="{{old('name',($permission->description) ?? '')}}" class="form-control" placeholder="" autocomplete="off" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
