                ...
                <div class="ibox-content">
                    <div class="seo-container">
                        <div class="h3 meta-title">
                                {{old('meta_title',($post->meta_title) ?? 'Bạn chưa có tiêu đề')}}
                        </div>
                        <div class="canonical">
                              {{old('canonical',($post->canonical) ?? 'Bạn chưa có đường dẫn')}}
                        </div>
                        <div class="meta-description">
                                 {{old('meta_description',($post->meta_description) ?? ' Bạn chưa có mô tả ')}}
                        </div>
                    </div>
                        ...
                        <div class="row mb-15">
                            ...
                            <label for="" class="control-label text-right" style="display: flex; justify-content: space-between !important; width: 100% !important;">
                                ...
                                <span class="count_meta-description" style="margin-left: auto !important;">0 kí tự</span>
                                  ...
                                  <textarea type="text" name="meta_description" value="{{old('meta_description',($post->meta_description) ?? '')}}" class="form-control" placeholder="" autocomplete="off">
