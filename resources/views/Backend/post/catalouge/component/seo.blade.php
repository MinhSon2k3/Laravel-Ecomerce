                ...
                <div class="ibox-content">
                    <div class="seo-container">
                        <div class="h3 meta-title">
                                {{old('meta_title',($postCatalouge->meta_title) ??  __('messages.seoTitle'))}}
                        </div>
                        <div class="canonical">
                              {{old('canonical',($postCatalouge->canonical)?? __('messages.seoCanonical'))}}
                        </div>
                        <div class="meta-description">
                                 {{old('meta_description',($postCatalouge->meta_description) ?? __('messages.seoDescription'))}}
                        </div>
                    </div>
