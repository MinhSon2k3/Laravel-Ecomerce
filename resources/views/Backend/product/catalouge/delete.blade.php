...
@endif
<form action="{{ route('product.catalouge.destroy', ['id' => $productCatalouge->id]) }}" method="post" class="box">
    @csrf
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <p> <strong>{{__('messages.deletenoitice')}}</strong> {{$productCatalouge->name}}</p>
